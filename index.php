...
<meta name="description" content="O Summit 1.0 é um evento tecnológico do Serviço de Formação de Vila Nova de Gaia. Que traz a perspetiva de recrutadores e empresas dessas áreas.">
<meta name="keywords" content="tecnologia, inovação, emprego, iefp, elea">
<meta name="robots" content="index,follow">
<meta property="og:title" content="Summit 1.0 - Serviço de Formação de Vila Nova de Gaia">
<meta property="og:description" content="O Summit 1.0 é um evento tecnológico do Serviço de Formação de Vila Nova de Gaia. Que traz a perspetiva de recrutadores e empresas dessas áreas.">
            ...
            <div class="col-lg-4 col-md-5 col-sm-8">
              <div class="card orador">
                ...
                <div class="col-lg-4 col-md-5 col-sm-8">
                  <div class="card orador">
                    <div class="cardimg">
                      <img src="./img/oradores/Rui Guedes - Ground Control Studios.jpg" alt="Orador SUMMIT - Rui Guedes">
                    </div>
                    <h3>Rui Guedes</h3>
                    <h4>Foundador da Ground Control Studios</h4>
                    <p>Mestrado em engenharia informática pela FEUP, Licenciado em Tecnologias de Comunicação Multimédia pelo Instituto Superior da Maia , é fundadador da Ground Control Studios. </p>
                  </div>
                </div>
                ...
                <div class="row cardHorario">
                    ...
                    <div class="col-md-8 col-8">
                        ...
                        <div class="cardAssunto">
                            ...
                            <h5>Raul Ralha</h5>
                            <p> As oportunidades e diculdades atuais nos eSports. <br> <span style="font-weight:bold"> *Presente na Sala de Exposições </span> </p>
  ...
  <section id="exposicao">
    ...
    <div class="container">
      ...
      <div class="speed_mapa col-8">
          ...
          <span style="font-weight: bold;">  Dia 11 </span> &nbsp   &nbsp <i class="fas fa-comments"></i>  SPEED RECRUITMENT        
      ...
      <div class="container">
        <div class="row">
          <div class="contadorDiv col-lg-3 col-md-3 col-sm-3">
            <p id="resultado">O evento começou!</p>
          </div>
...
<!--
          ...
          <div class="contadorDiv col-lg-3 col-md-3 col-sm-3 ">
            <a href="#preInscricao"><button class="chamada">Pré-inscrição</button></a>
          </div>
        </div>
      </div>
    </div>
