    ...
    switch ($prev_status) {
        case 0:
            ...
            if($registo->update()){
                ...
                // tell the user
                echo json_encode(array("message" => "O registo foi confirmado!"));
            ...
            else
            {
                ...
                // tell the user
                echo json_encode(array("message" => "Ocorreu um erro. Impossivel Confirmar registo!"));
            }
            break;
        default: // Registo existe, mas o status é diferente de zero (já confirmado)
            ...
            http_response_code(200);
            // tell the user
            echo json_encode(array("message" => "O Registo ja se encontrava confirmado!"));
            break; 
    }
