       ...
       // Envio do email
        ...
        switch ($tipo) {
            ...
            case 4: // Confirma anulacao
                ...
                // prepara link de confirmacao a incluir no email
                $link = "<a href=" . $external_url_site . "><b>" . $external_url_site . "</b></a>";
        ...
        if (mail($to, "Summit 1.0 - V.N.G.", $msg, $headers)) {
            if ($test) { echo json_encode(array("message" => 'Your mail has been sent successfully.')); }
        } else {
            if ($test) { echo json_encode(array("message" => 'Unable to send email. Please try again.')); }
        }
        // end of the message         
