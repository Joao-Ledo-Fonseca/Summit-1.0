...
class Registo{
    ...
    function read() {
        ...
        // select all query
        $query = "SELECT
                    r.id, r.email, r.nome, r.apelido, r.telefone, r.status, r.codigo, r.cod_confirm, r.consentimento, r.datareg, r.S1, r.S2, r.S3, r.S4
                FROM
                    " . $this->table_name . " r
                ORDER BY
                     r.nome";
    ...
    $this->consentimento=htmlspecialchars(strip_tags($this->consentimento));
        ...
        $this->S2=htmlspecialchars(strip_tags($this->S2));
        $this->S3=htmlspecialchars(strip_tags($this->S3));
        $this->S4=htmlspecialchars(strip_tags($this->S4));
